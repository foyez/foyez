...
I am a **Software Engineer** with several years of professional experience. I specialize in in frontend development and backend API development. I am passionate about learning and developing applications using modern technologies.

My current skillsets constitutes web application development using technologies like **Typescript**, **React**, **NodeJS**, **Python**, **Go**, **AWS** and **Docker**.
